...
public class UserEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2702807851794997649L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserEvent\",\"namespace\":\"com.kafka.kafka_stream.model\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"action\",\"type\":\"string\"}]}");
   ...
   */
  public UserEvent(java.lang.CharSequence userId, java.lang.CharSequence action) {
    this.userId = userId;
    this.action = action;
  }
   ...
   */
  public static com.kafka.kafka_stream.model.UserEvent.Builder newBuilder() {
    return new com.kafka.kafka_stream.model.UserEvent.Builder();
  }
   ...
   * @return A new UserEvent RecordBuilder
   */
  public static com.kafka.kafka_stream.model.UserEvent.Builder newBuilder(com.kafka.kafka_stream.model.UserEvent.Builder other) {
    if (other == null) {
      return new com.kafka.kafka_stream.model.UserEvent.Builder();
    } else {
      return new com.kafka.kafka_stream.model.UserEvent.Builder(other);
    }
  }
   ...
   * @return A new UserEvent RecordBuilder
   */
  public static com.kafka.kafka_stream.model.UserEvent.Builder newBuilder(com.kafka.kafka_stream.model.UserEvent other) {
    if (other == null) {
      return new com.kafka.kafka_stream.model.UserEvent.Builder();
    } else {
      return new com.kafka.kafka_stream.model.UserEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.kafka_stream.model.UserEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.kafka_stream.model.UserEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.kafka_stream.model.UserEvent.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.kafka_stream.model.UserEvent.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.kafka_stream.model.UserEvent.Builder setAction(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.kafka_stream.model.UserEvent.Builder clearAction() {
      action = null;
